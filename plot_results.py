"""
Plot results from coursework2_medium simulation.
"""
import os
import pandas as pd
...
# Load the CSV file
results_dir = "results"
csv_file = os.path.join(results_dir, "coursework2_medium_50gens.csv")
...
fig.suptitle('Predator-Prey Co-Evolution Results', fontsize=16, fontweight='bold')
...
# Save plot
plot_file = os.path.join(results_dir, "coursework2_medium_plot.png")
